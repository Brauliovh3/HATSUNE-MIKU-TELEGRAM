      ...
      try {
        ...
        await ctx.replyWithPhoto(thumbnailUrl, {
          ...
          ...global.Markup.inlineKeyboard([
            ...
            [global.Markup.button.callback('📹 MOV', `mov_${videoId}`), global.Markup.button.callback('🎞️ MKV', `mkv_${videoId}`)],
            [global.Markup.button.callback('🎧 FLAC', `flac_${videoId}`), global.Markup.button.callback('🎵 AAC', `aac_${videoId}`)],
            [global.Markup.button.callback('📽️ WEBM', `webm_${videoId}`), global.Markup.button.callback('🎥 3GP', `3gp_${videoId}`)],
            [global.Markup.button.callback('🎵 OGG', `ogg_${videoId}`), global.Markup.button.callback('🎥 M4V', `m4v_${videoId}`)]
          ])
        });
      } catch (infoError) {
